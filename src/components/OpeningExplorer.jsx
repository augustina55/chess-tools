  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      >
        ...
        <span className="text-xs ml-auto" style={{ color: '#6b5f58' }}>Powered by Lichess Masters</span>
      </div>
      ...
      <div className="flex-1 min-h-0 flex overflow-hidden">
        ...
        <div className="flex-1 min-w-0 flex flex-col overflow-hidden" style={{ background: C.bg }}>
          ...
          {generating && (
            <div className="flex-1 flex flex-col items-center justify-center gap-4 p-8">
              ...
              <p className="text-xs" style={{ color: C.dim }}>
                ~{estimatedCalls} positions to check
              </p>
            </div>
          )}
        ...
        >
          <BoardPreview fen={previewFen} label={previewLabel} />
          {previewFen && (
            <p className="text-[10px] mt-3 text-center" style={{ color: C.dim }}>
              Click ♟ on any variation to preview its final position
            </p>
          )}
        </div>
      </div>
